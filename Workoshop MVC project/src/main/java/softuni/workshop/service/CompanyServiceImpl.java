...
public class CompanyServiceImpl implements CompanyService {
    private static final String COMPANIES_XML_FILE_PATH = "C:\\Users\\Иван Йовов\\IdeaProjects\\Hibernate\\Workoshop MVC project\\src\\main\\resources\\files\\xmls\\companies.xml";
    ...
    public void importCompanies() throws JAXBException {
        ...
        for (CompanyDto companyDto : companyRootDto.getCompanyDtos()) {
            ...
            if (!this.validatorUtil.isValid(company)) {
                this.validatorUtil.printErrors(company);
                continue;
            }
