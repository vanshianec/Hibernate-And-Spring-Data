...
public class OrderServiceImpl implements OrderService {
    ...
    private static final String ORDER_XML_FILE_PATH = "C:\\Users\\Иван Йовов\\IdeaProjects\\Hibernate\\Exams\\09 December 2018\\AlaraRestaurant\\src\\main\\resources\\files\\orders.xml";
    ...
    public String importOrders() throws JAXBException {
        ...
        for (OrderDto orderDto : orders.getOrders()) {
            ...
            stringBuilder.append(String.format("Order for %s on %s added", orderDto.getCustomer(), orderDto.getDateTime())).append(System.lineSeparator());
        }
